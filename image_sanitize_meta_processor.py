...
def get_image_description(image_path: str, timeout: int = 30) -> str:
    """
    ...
    try:
        ...
        payload = {
            "model": "llava-llama3",
            "prompt": "Describe this image in great detail using 1 large paragraph.",
            "images": [base64_image],
            "stream": True,
        }
...
def main():
    ...
    print("1. Sanitize filenames (replace spaces with underscores)")
